...
Latest tag is `v1.7.0`. Use the shadcn CLI version pinned in [`deps-allowlist.json`](deps-allowlist.json):

```bash
npx shadcn@4.21.0 add Tristan2828/ui-foundation/starter#v1.7.0
```
